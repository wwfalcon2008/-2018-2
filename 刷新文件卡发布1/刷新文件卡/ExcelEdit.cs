...
namespace 刷新文件卡
{
    public class ExcelEdit
    {
        ...
        //列宽自适应
        //public void ColumnWidthAutoFit(string sheetName)
        //{
        //    Microsoft.Office.Interop.Excel.Range range = wss[sheetName].Columns;
        ...
        public string Read(int row, int column)
        {
            string cellValue = "";
            //读取表格数据（需确定行数）                     
            cellValue = ((Range)ws.Cells[row, column]).Text;
